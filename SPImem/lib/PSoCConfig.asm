...
export LoadConfig_spimem
export _LoadConfig_spimem
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_spimem
	lcall	LoadConfigTBL_spimem_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration spimem
;
;    Load configuration registers for spimem.
...
_LoadConfig_spimem:
 LoadConfig_spimem:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_spimem_Bank0
    mov     X, <LoadConfigTBL_spimem_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_spimem_Bank1
    mov     X, <LoadConfigTBL_spimem_Bank1
