...
export LoadConfigTBL_spimem_Bank1
export LoadConfigTBL_spimem_Bank0
...
;  Global Register values Bank 1
	...
	db		e1h, 52h		; OscillatorControl_1 register (OSC_CR1)
...
;  Ordered Global Register values
	...
	M8C_SetBank0
	mov	reg[07h], 3fh		; Port_1_DriveMode_2 register (PRT1DM2)
