...
RAM_SETPAGE_CUR >_rx_end
   mov  A,[_rx_end]								; Leo la posicion
   inc  A								; Incremento el puntero
   and  A,RX_BUFFER_SIZE-1				; Saco overflow
   mov  X,A
